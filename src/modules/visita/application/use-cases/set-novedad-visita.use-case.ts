...
export class SetNovedadVisitaUseCase {
    ...
    async setNovedad(visita: number, descripcion: string, novedad_tipo: string, imagenes: any): Promise<any> {
        return await this.repo.setNovedad(visita, descripcion, novedad_tipo, imagenes);
    }
}