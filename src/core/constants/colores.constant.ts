const COLORES = {
    ...
    ROJO_SUAVE: "rgba(248, 109, 109, 0.30)",
    ROJO_FUERTE: "rgba(200, 0, 0, 1)",
    AZUL_FUERTE: "rgba(33, 97, 204, 1)",
    BLANCO: "rgba(255, 255, 255, 1)",
    NEGRO: "rgba(30, 30, 30 ,1)",
    GRIS_MEDIO: "rgba(120, 120, 120, 1)",
    GRIS_OSCURO: "rgba(51, 51, 51, 1)"
} as const;
