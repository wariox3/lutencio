...
const lightPalette = ['hsla(0, 16%, 94%, 1)','hsla(0, 16%, 89%, 1)','hsla(0, 16%, 84%, 1)','hsla(0, 16%, 79%, 1)','hsla(0, 16%, 74%, 1)','hsla(0, 16%, 70%, 1)','hsla(0, 16%, 65%, 1)','hsla(0, 16%, 60%, 1)','hsla(0, 16%, 55%, 1)','hsla(0, 16%, 50%, 1)','hsla(0, 15%, 15%, 1)','hsla(0, 15%, 1%, 1)']
